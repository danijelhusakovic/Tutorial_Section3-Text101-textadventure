...
public class TextController : MonoBehaviour {
	...
	#region all of the state functions
	...
	void closet_door() {
		text.text = "You are looking at a closet door, unfortunately it's locked. " +
					"Maybe you could find something aroun to help encourage it open?\n\n" +
	...
	void corridor_0() {
		text.text = "You're out of your cell, but not out of trouble. " +
					...
					"C to view Closet. F to inspect the Floor. S to climb the Stairs.";	
